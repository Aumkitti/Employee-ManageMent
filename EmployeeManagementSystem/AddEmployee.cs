...
namespace EmployeeManagementSystem
{
    ...
    {
        SqlConnection connect = new SqlConnection(@"Data Source=(LocalDB)\MSSQLLocalDB;AttachDbFilename=C:\Users\msi\Documents\loginData.mdf;Integrated Security=True;Connect Timeout=30");
                    ...
                    try
                    {
                        ...
                        using(SqlCommand checkEm = new SqlCommand(checkEmID, connect))
                        {
                            ...
                            else
                            {
                                ...
                                string path = Path.Combine(@"D:\Users\msi\Desktop\EmployeeManagement\EmployeeManagementSystem\Directory\"
